        ...
        <div className="md:bg-white/50 backdrop-blur-xs dark:md:bg-gray-800   p-4 space-y-6 max-h-full min-h-0 flex flex-col flex-1 overflow-y-auto max-sm:bg-transparent  max-sm:w-full  max-sm:py-0 max-sm:px-0 max-sm:space-y-3">
            ...
            <div id="ITEM 1" className='max-sm:w-full '>
                <div className="flex items-center gap-4 max-sm:flex-col max-sm:w-full max-md:flex-col sm:flex-row ">
                    ...
                    <div>
                        <div className="text-2xl font-bold text-blue-800 dark:text-sky-500 pt-1 pl-4 max-sm:max-w-full max-sm:px-0 ">
                        ...
                        <div className="pl-4 flex gap-4 max-sm:text-sm max-sm:px-0">
                            ...
                            <button> <EllipsisHorizontalIcon className="h-8 w-8 text-gray-700 dark:text-white cursor-pointer"> </EllipsisHorizontalIcon> </button>
                        </div>

        ...
        <div className="backdrop-blur-md shadow-md   flex flex-col flex-1   max-sm:w-full  max-sm:py-0 max-sm:px-0">
            ...
            <div id="ITEM 1" className='max-sm:w-full'>
                <div className="flex items-center gap-4 max-sm:flex-col max-sm:w-full max-md:flex-col sm:flex-row ">
                    ...
                    <div>
                        <div className="text-2xl font-bold text-blue-800 font-sans dark:text-sky-500 pt-1 pl-4 max-sm:max-w-full max-sm:px-0 ">
                            College of Public Affairs and Development
                        </div>
                        <div className="mt-1 font-bold text-black dark:text-white text-xl pl-4 max-sm:w-full max-sm:px-0">
                            <a href="/coming-soon" className="hover:underline ">Internship</a>
                        </div>



                        <div className="mt-2 text-s text-gray-700 dark:text-gray-300 text-justify p-4 max-sm:w-full max-sm:text-sm max-sm:px-0 ">
                        ...
                        <div className="pl-4 flex gap-4 max-sm:text-sm max-sm:px-0 items-center">
                            ...
                            <EllipsisHorizontalIcon className="h-8 w-8 text-gray-700 dark:text-white cursor-pointer"> </EllipsisHorizontalIcon>
                        </div>
            ...
            <div id="ITEM 2" className='max-sm:w-full'>
                <div className="flex items-center gap-4 max-sm:flex-col max-sm:w-full max-md:flex-col sm:flex-row">
                    ...
                    <div>
                        ...
                        <div className="mt-1 font-bold text-black dark:text-white text-xl pl-4 max-sm:px-0">
                            <a href="/coming-soon" className="hover:underline">Computer Science - Major in Intelligent Systems</a>
                        </div>
                        <div className="mt-2 text-s text-gray-700 dark:text-gray-300 text-justify p-4 max-sm:text-sm max-sm:w-full max-sm:px-0">
            ...
            <div id="ITEM 2" className='max-sm:w-full '>
                ...
                <div className="flex items-center gap-4 max-sm:flex-col max-sm:w-full max-md:flex-col sm:flex-row">
                    ...
                    {/* Description on the left */}
                    <div>
                        <div className="text-2xl font-bold text-blue-800 dark:text-sky-500 pt-1 pl-4 max-sm:px-0">
                            Los Banos Senior High School
                        </div>
                        <div className="mt-1 font-bold text-black dark:text-white text-xl pl-4 max-sm:px-0">
                            <a href="/coming-soon" className="hover:underline">STEM Track</a>
                        </div>
                        <div className="mt-2 text-s text-gray-700 dark:text-gray-300 text-justify p-4 max-sm:text-sm max-sm:w-full max-sm:px-0">
                        ...
                        <div className="pl-4 flex gap-4 max-sm:text-sm max-sm:px-0 items-center">
                            <button className="btn-primary" aria-label="Go to Background">Documentation</button>
                            <EllipsisHorizontalIcon className="h-8 w-8 text-gray-700 dark:text-white cursor-pointer"> </EllipsisHorizontalIcon>
                        </div>
